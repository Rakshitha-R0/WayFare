...
let userSchema = new Schema(
  {
    ...
    password: {
      ...
      required: [function() { return !this.googleId; }, "password is a required field"],
    },
    confirmPassword: {
      type: String,
      select: false,
      minLength: [6, "Min character length is 6"],
      required: [function() { return !this.googleId; }, "Confirm password is a required field"],
      validate: {
        validator: function (value) {
          // Only validate if not a Google user
